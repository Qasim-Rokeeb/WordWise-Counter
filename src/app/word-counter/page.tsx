...
export default function WordCounterPage() {
  ...
  return (
    <main className="flex min-h-screen w-full flex-col items-center justify-start p-4 pt-12 sm:p-8">
       <Header />
      <div className="w-full max-w-2xl relative mt-8">
        <Card className="shadow-2xl shadow-primary/10 border-4 border-primary/10">
          <CardHeader>
            <CardTitle className="text-center text-3xl font-bold tracking-tight text-primary md:text-4xl">
              WordWise Counter
            </CardTitle>
